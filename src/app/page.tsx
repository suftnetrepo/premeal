      ...
      {!isLocationSearch && (
        <section className="bg-gradient-to-b from-orange-50/60 to-white border-b border-stone-100">
          <div className="mx-auto max-w-7xl grid md:grid-cols-2 gap-10 md:gap-8 px-4 py-10 md:py-14">
            ...
            <div className="relative flex items-center justify-center min-h-[360px] rounded-2xl overflow-hidden">
              <Image
                src="/hero.jpg"
              ...
              {/* Fades the photo's left edge into the section's cream
                  ...
                  the text column — same technique used before the
                  placeholder-image detour, now applied to a real photo
                  instead of a stock/random one. Kept narrow (not the
                  full width) so it softens the seam without washing out
                  the photo itself. */}
